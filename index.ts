...
customGamesEntry.AddShortDescription('Supported Games', 'List of supported custom games with additional features', 1,ImageData.Icons.chat_arrow_down)

EventsSDK.on('GameStarted', () => {
    switch (GameState.AddonName) {
        case '2860562213': {
            customGameNode = customGamesEntry.AddNode('SpinTD Inject', ImageData.Icons.gold_large, 'Inject SpinTD features into the game')
