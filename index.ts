...
const customGamesEntry2 = Menu.AddEntry('Custom Games3', ImageData.Icons.arrow_plus_stats_red)
const customGamesEntry3 = Menu.AddEntry('Custom Games4', ImageData.Icons.gold_large)
const customGamesEntry4 = Menu.AddEntry('Custom Games5', ImageData.Icons.icon_svg_hamburger)
